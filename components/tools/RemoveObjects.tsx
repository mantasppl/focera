      ...
      <div className="tool-panel tool-panel--preview">
          ...
          {loading ? (
            ...
            <div className="remove-objects__paint">
              ...
              <p className="tool-placeholder preview-single__hint">
                Brush over people, objects, or distractions, then click Remove
                objects.
              </p>
            </div>
          ) : (
            <p className="tool-placeholder">
              Upload a photo to mark and remove unwanted objects
            </p>
          )}
        </div>
        ...
        <p className="tool-hint">
          {hasResult
            ...
            : "Paint the object, restore the area in your browser · files never upload to Focera"}
        </p>
      </div>
    </div>
  );
