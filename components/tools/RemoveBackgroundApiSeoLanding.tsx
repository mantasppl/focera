...
const FEATURES = [
  {
    title: "No endpoint to provision",
    description:
      "This page is not a REST API. You upload a file in the browser, run cutout locally, and download PNG or WebP.",
  },
  {
...
export default function RemoveBackgroundApiSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="remove-background-api-features"
        title="Everything you need in Remove Background API"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          Searching for a remove-background API often means keys and invoices. Focera is the opposite: local inference when you just need a file, with nothing posted to a removal service.
        </p>
        <ol className="tool-content__steps">
          ...
          <li>
            <strong>Remove the background in the browser.</strong> Click Make
        ...
        <p>
          Jump back to the{" "}
          <a href="#remove-background-api-tool">
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Prototype days</strong> — Get a PNG without standing up a vendor account.
          </li>
          <li>
            <strong>One-off jobs</strong> — Skip billing for a single cutout.
          </li>
          <li>
            <strong>Privacy-sensitive stills</strong> — Keep the original on this device.
          </li>
          <li>
            <strong>Design QA</strong> — Inspect edges before you ever consider an API.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After this remove-background API alternative, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
