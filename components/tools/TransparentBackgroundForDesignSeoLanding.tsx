...
const FEATURES = [
  {
    title: "Transparency the layout can use",
    description:
      "Empty pixels, not a fake checkerboard baked into the photo.",
  },
  {
...
export default function TransparentBackgroundForDesignSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="transparent-background-for-design-features"
        title="Everything you need in Transparent Background for Design"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          A transparent background for design should survive import into other editors. Focera writes real alpha after a local cutout.
        </p>
        <ol className="tool-content__steps">
          ...
          <li>
            <strong>Make a transparent background for design.</strong> Click Make
        ...
        <p>
          Jump back to the{" "}
          <a href="#transparent-background-for-design-tool">
            transparent background for design tool
          </a>{" "}
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Figma-style frames</strong> — Place a subject on a frame fill without a matte.
          </li>
          <li>
            <strong>Print knockouts</strong> — Give a RIP empty pixels around a product.
          </li>
          <li>
            <strong>Motion stills</strong> — Export a PNG you can later animate on a new plate.
          </li>
          <li>
            <strong>Icon-adjacent photos</strong> — Sit a real object next to vector UI.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After you get a transparent background for design, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
