...
export default function CombinePhoto() {
  ...
  async function handleCombine() {
    ...
    try {
      ...
      setResult(combined);
      downloadCombinedPhoto(combined.blob, files);
      setProgressText("");
      trackSuccess();
    } catch (err) {
  ...
  function handleDownloadAgain() {
    ...
    downloadCombinedPhoto(result.blob, files);
  }

  return (
    <div className="tool-grid combine-photo">
      <div className="tool-panel">
        ...
        <div className="combine-photo__options">
          ...
          <div className="ui-field">
            ...
            <p className="ui-hint">
              Add {MIN_COMBINE_FILES}–{MAX_COMBINE_FILES} photos, then combine
              into one PNG collage.
            </p>
          </div>
        </div>
      ...
      <div className="tool-panel tool-panel--preview">
        ...
        >
          {loading ? (
            ...
            <div className="combine-photo__success">
              <p className="combine-photo__success-title">Combined photo ready</p>
            ...
            <div className="combine-photo__empty">
              <p className="combine-photo__success-title">
