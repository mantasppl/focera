...
export default function PngToSvg() {
  ...
  async function handleConvert() {
    ...
    try {
      ...
      await downloadPngSvgResult(converted, files);
      setProgressText("");
      trackSuccess();
    } catch (err) {
      ...
      <div className="tool-panel tool-panel--preview">
          ...
          {loading ? (
            ...
            <div className="png-to-pdf__empty">
              <p className="tool-placeholder">
                {fileCount === 0
                  ? "Upload a PNG image to convert it to SVG"
        ...
        <p className="tool-hint">
          {hasResult
            ...
            : "PNG to SVG runs in your browser · files never upload to Focera"}
        </p>
      </div>
    </div>
  );
