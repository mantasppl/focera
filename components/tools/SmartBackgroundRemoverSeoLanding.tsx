...
const FEATURES = [
  {
    title: "The model finds the subject",
    description:
      "You do not draw a rough lasso first. Review the edge with the slider, then crop or outline if you want.",
  },
  {
...
export default function SmartBackgroundRemoverSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="smart-background-remover-features"
        title="Everything you need in Smart Background Remover"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          A smart background remover should still leave you in control of the export. Focera isolates the subject locally, then you refine on the same page.
        </p>
        <ol className="tool-content__steps">
          ...
          <li>
            <strong>Run smart cutout.</strong> Click Make
        ...
        <p>
          Jump back to the{" "}
          <a href="#smart-background-remover-tool">
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Mixed lighting</strong> — Isolate a face when a lamp and a window both hit the scene.
          </li>
          <li>
            <strong>Small objects</strong> — Lift a ring off a busy jewelry tray.
          </li>
          <li>
            <strong>Group-adjacent shots</strong> — Clear a wall when another person sits at the edge.
          </li>
          <li>
            <strong>Patterned backdrops</strong> — Separate a product from a printed tablecloth.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After this smart background remover, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
