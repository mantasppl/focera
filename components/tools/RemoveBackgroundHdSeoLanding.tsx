...
const FEATURES = [
  {
    title: "Keep the pixels you uploaded",
    description:
      "Cutout follows the file you provide (up to 10 MB). There is no forced downscale to a tiny preview as the export.",
  },
  {
...
export default function RemoveBackgroundHdSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="remove-background-hd-features"
        title="Everything you need in Remove Background HD"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          Remove background HD here means working from your upload, then downloading PNG or WebP. The first run still caches the model in this browser.
        </p>
        ...
        <p>
          Jump back to the{" "}
          <a href="#remove-background-hd-tool">
            remove background hd tool
          </a>{" "}
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Large pack shots</strong> — Keep label type readable after the shelf is gone.
          </li>
          <li>
            <strong>Poster prints</strong> — Isolate a person for a tabloid flyer without a muddy edge.
          </li>
          <li>
            <strong>Zoom crops</strong> — Clear a backdrop before you enlarge a detail later.
          </li>
          <li>
            <strong>Retail lookbooks</strong> — Export a garment with fabric texture still visible.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After you remove a background in HD, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
