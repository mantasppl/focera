...
const FEATURES = [
  {
    title: "Cutout without an install",
    description:
      "Open the tab, drop a photo, and keep a PNG with real alpha — no desktop mask workspace.",
  },
  {
...
export default function RemoveBackgroundOnlineSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="remove-background-online-features"
        title="Everything you need in Remove Background Online"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          Removing a background online should not start with an installer. Focera keeps upload, cutout, and download on one page with no account.
        </p>
        <ol className="tool-content__steps">
          ...
          <li>
            <strong>Remove the background online.</strong> Click Make
        ...
        <p>
          Jump back to the{" "}
          <a href="#remove-background-online-tool">
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Hotel-room products</strong> — Lift an item off a cluttered travel desk for a same-day listing.
          </li>
          <li>
            <strong>Remote proofs</strong> — Send a client a PNG before you sit down at a desktop editor.
          </li>
          <li>
            <strong>Newsletter blocks</strong> — Isolate a speaker so they sit on a campaign color.
          </li>
          <li>
            <strong>Mockup art</strong> — Clear a table behind a sketch so it can sit on a shirt template.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After you remove a background online, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
