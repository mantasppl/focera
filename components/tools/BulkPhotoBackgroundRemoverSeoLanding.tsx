...
const FEATURES = [
  {
    title: "Photographs in a stack",
    description:
      "Point it at JPEGs from a shoot. Process photo 1, then photo 2, with the model already cached.",
  },
  {
...
export default function BulkPhotoBackgroundRemoverSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="bulk-photo-background-remover-features"
        title="Everything you need in Bulk Photo Background Remover"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          A bulk photo background remover here does not ingest a RAW catalog. Upload export-sized JPG, PNG, or WebP up to 10 MB each.
        </p>
        <ol className="tool-content__steps">
          ...
          <li>
            <strong>Remove the next photo background.</strong> Click Make
        ...
        <p>
          Jump back to the{" "}
          <a href="#bulk-photo-background-remover-tool">
            bulk photo background remover tool
          </a>{" "}
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Studio days</strong> — Clear paper sweeps behind each pack shot.
          </li>
          <li>
            <strong>Home inventory</strong> — Isolate household goods for insurance photos.
          </li>
          <li>
            <strong>Pet portraits</strong> — Work through a set of animals on the same blanket.
          </li>
          <li>
            <strong>Sports extras</strong> — Cut players free from a gym wall one still at a time.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After this bulk photo background remover, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
