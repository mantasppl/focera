...
const FEATURES = [
  {
    title: "One page, no paywall",
    description:
      "Upload once and export a PNG. The removal tool does not hide download behind a plan.",
  },
  {
...
export default function FreeBackgroundRemovalToolSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="free-background-removal-tool-features"
        title="Everything you need in Free Background Removal Tool"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          A free background removal tool should not nickle-and-dime the file. Focera runs cutout in your browser with no account.
        </p>
        ...
        <p>
          Jump back to the{" "}
          <a href="#free-background-removal-tool-tool">
            free background removal tool tool
          </a>{" "}
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Weekend markets</strong> — Clear a folding-table cloth behind a candle you will list tonight.
          </li>
          <li>
            <strong>Club newsletters</strong> — Isolate a coach for a header that sits on brand color.
          </li>
          <li>
            <strong>Garage sales</strong> — Lift a lamp off a cluttered shelf for a local listing.
          </li>
          <li>
            <strong>School projects</strong> — Cut a science-fair object free without buying software.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After you use this free background removal tool, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
