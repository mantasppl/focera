...
const FEATURES = [
  {
    title: "AI inference without an AI API",
    description:
      "The model runs in your browser. You are not calling a hosted segmentation endpoint.",
  },
  {
...
export default function AiBackgroundRemovalApiSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="ai-background-removal-api-features"
        title="Everything you need in AI Background Removal API"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          An AI background-removal API is a cloud product. This page downloads a model once, caches it, and keeps every extra file on the device.
        </p>
        <ol className="tool-content__steps">
          ...
          <li>
            <strong>Run AI cutout locally.</strong> Click Make
        ...
        <p>
          Jump back to the{" "}
          <a href="#ai-background-removal-api-tool">
            ai background removal api tool
          </a>{" "}
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Secret products</strong> — Avoid posting frames to a model vendor.
          </li>
          <li>
            <strong>Cost control</strong> — Skip per-image AI invoices for casual use.
          </li>
          <li>
            <strong>Edge inspection</strong> — See quality before you commit to a hosted API.
          </li>
          <li>
            <strong>Travel days</strong> — Work from cached weights after the first visit.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After this AI background-removal API alternative, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
