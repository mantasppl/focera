...
const FEATURES = [
  {
    title: "Camera file to PNG quickly",
    description:
      "After the model is cached, a phone JPEG can become a cutout without a desktop round-trip.",
  },
  {
...
export default function InstantPhotoBackgroundRemovalSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="instant-photo-background-removal-features"
        title="Everything you need in Instant Photo Background Removal"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          Instant photo background removal still caches the model once. Focera then keeps each extra shot on this page with no account.
        </p>
        ...
        <p>
          Jump back to the{" "}
          <a href="#instant-photo-background-removal-tool">
            instant photo background removal tool
          </a>{" "}
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Booth photography</strong> — Clear a backdrop between customers at a pop-up.
          </li>
          <li>
            <strong>Same-day social</strong> — Isolate a dish from a lunch table for an afternoon post.
          </li>
          <li>
            <strong>Field sales</strong> — Cut a sample free in the parking lot after a visit.
          </li>
          <li>
            <strong>Newsroom standups</strong> — Place a reporter on a show open without the newsroom wall.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After instant photo background removal, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
