...
const FEATURES = [
  {
    title: "One control starts cutout",
    description:
      "After upload, a single Make background transparent action runs segmentation. Refine comes after, not before.",
  },
  {
...
export default function OneClickBackgroundRemoverSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="one-click-background-remover-features"
        title="Everything you need in One Click Background Remover"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          A one-click background remover still lets you crop and outline after the cutout. Focera just does not make you configure a mask first.
        </p>
        <ol className="tool-content__steps">
          ...
          <li>
            <strong>Click to remove the background.</strong> Click Make
        ...
        <p>
          Jump back to the{" "}
          <a href="#one-click-background-remover-tool">
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Phone-only days</strong> — Clear a backdrop without a settings tour on a small screen.
          </li>
          <li>
            <strong>Volunteer shifts</strong> — Hand the page to someone who has not used an editor.
          </li>
          <li>
            <strong>Kiosk demos</strong> — Show cutout with one control at a trade table.
          </li>
          <li>
            <strong>Quick stickers</strong> — Export a person as a PNG between messages.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After this one-click background remover, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
