...
const FEATURES = [
  {
    title: "Clean means empty pixels",
    description:
      "This cleaner removes the backdrop, not dust or noise. Export alpha, then use other tools if you need compression.",
  },
  {
...
export default function BatchImageCleanerSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="batch-image-cleaner-features"
        title="Everything you need in Batch Image Cleaner"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          A batch image cleaner on this page is sequential cutout. Focera does not denoise or sharpen; it isolates the subject locally.
        </p>
        <ol className="tool-content__steps">
          ...
          <li>
            <strong>Clean the next image background.</strong> Click Make
        ...
        <p>
          Jump back to the{" "}
          <a href="#batch-image-cleaner-tool">
            batch image cleaner tool
          </a>{" "}
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Desk product stacks</strong> — Clean monitors out from behind each gadget.
          </li>
          <li>
            <strong>Kitchen crafts</strong> — Clean counters out from behind each jar.
          </li>
          <li>
            <strong>Yard tools</strong> — Clean grass out from behind each listing.
          </li>
          <li>
            <strong>Library scans</strong> — Clean scanner lids out from behind each object.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After this batch image cleaner, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
