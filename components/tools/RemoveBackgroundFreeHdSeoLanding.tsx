...
const FEATURES = [
  {
    title: "HD export without a paid tier",
    description:
      "The download is PNG or WebP from the file you provided, not a watermarked miniature behind a paywall.",
  },
  {
...
export default function RemoveBackgroundFreeHdSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="remove-background-free-hd-features"
        title="Everything you need in Remove Background Free HD"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          Remove background free HD means no invoice for a larger file. The 10 MB upload cap still applies, and the model caches in this browser on first run.
        </p>
        ...
        <p>
          Jump back to the{" "}
          <a href="#remove-background-free-hd-tool">
            remove background free hd tool
          </a>{" "}
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Print flyers</strong> — Keep a subject sharp enough for a letter-size sheet.
          </li>
          <li>
            <strong>Marketplace zooms</strong> — Let shoppers pinch-zoom a bottle label after the shelf is gone.
          </li>
          <li>
            <strong>Lookbook crops</strong> — Isolate a garment you may crop tighter later.
          </li>
          <li>
            <strong>Poster comps</strong> — Place a person on a large layout without a tiny source.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After you remove a background free in HD, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
