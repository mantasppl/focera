...
const FEATURES = [
  {
    title: "Empty pixels, not a checkerboard stamp",
    description:
      "The checkerboard is only a preview. The file you download really has alpha.",
  },
  {
...
export default function TransparentBackgroundOnlineSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="transparent-background-online-features"
        title="Everything you need in Transparent Background Online"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          A transparent background online should be a real channel, not a gray-and-white JPEG. Focera writes PNG or WebP locally with no account.
        </p>
        ...
        <p>
          Jump back to the{" "}
          <a href="#transparent-background-online-tool">
            transparent background online tool
          </a>{" "}
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Dark-mode sites</strong> — Place a subject on black without a leftover halo box.
          </li>
          <li>
            <strong>Print heat transfers</strong> — Export alpha so a vinyl cutter sees the silhouette.
          </li>
          <li>
            <strong>Overlay ads</strong> — Sit a person on video poster frames.
          </li>
          <li>
            <strong>App empty states</strong> — Drop an illustrated object onto a UI color.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After you get a transparent background online, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
