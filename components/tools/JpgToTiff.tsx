...
export default function JpgToTiff() {
  ...
  async function handleConvert() {
    ...
    try {
      ...
      await downloadJpgTiffResult(converted, files);
      setProgressText("");
      trackSuccess();
    } catch (err) {
  ...
  function handleDownloadSelected() {
    ...
    downloadConvertedTiff(activeImage);
  }
        ...
        >
          {loading ? (
            ...
            <div className="png-to-pdf__success">
              <p className="png-to-pdf__success-title">TIFF ready</p>
            ...
            <div className="png-to-pdf__empty">
              <p className="tool-placeholder">
                {fileCount === 0
                  ? "Upload a JPG image to convert it to TIFF"
