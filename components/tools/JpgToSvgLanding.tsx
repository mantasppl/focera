...
const FEATURES = [
  {
    title: "JPG to SVG in your browser",
    description:
      "Trace JPG logos, icons, and illustrations into editable SVG paths you can open in design tools or drop into the web.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Upload up to 10 JPG files at once. One image downloads as SVG; batches download as a ZIP.",
  },
  {
...
export default function JpgToSvgLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="jpg-to-svg-features"
        title="Everything you need in a free JPG to SVG converter"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          JPG is a raster format made of pixels. SVG is vector — shapes and
          paths that stay sharp at any size. Focera traces your JPG into SVG
        ...
        <ol className="tool-content__steps">
          <li>
            ...
            images (up to 10 MB each), or click the zone to browse. Add up to 10
        ...
        <p>
          Jump back to the{" "}
          <a href="#jpg-to-svg-tool">JPG to SVG converter</a> anytime to
      ...
      >
        ...
        <p>
          SVG scales cleanly for logos, icons, and UI assets. Converting a JPG
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Logos and brand marks</strong> — Turn a JPG logo into
      ...
      >
        ...
        <p>
          Your JPG files are traced entirely in your browser. Focera does not
