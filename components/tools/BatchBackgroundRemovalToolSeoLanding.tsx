...
const FEATURES = [
  {
    title: "A batch you drive yourself",
    description:
      "No multi-select queue. Treat the page as a repeatable station: upload, cut out, download, repeat.",
  },
  {
...
export default function BatchBackgroundRemovalToolSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="batch-background-removal-tool-features"
        title="Everything you need in Batch Background Removal Tool"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          A batch background removal tool on Focera is sequential and local. That keeps every original on this device instead of packing a zip onto a server.
        </p>
        <ol className="tool-content__steps">
          ...
          <li>
            <strong>Remove the next file's background.</strong> Click Make
        ...
        <p>
          Jump back to the{" "}
          <a href="#batch-background-removal-tool-tool">
            batch background removal tool tool
          </a>{" "}
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>SKU tables</strong> — Move down a spreadsheet of shots in one sitting.
          </li>
          <li>
            <strong>Class photos</strong> — Isolate students one portrait at a time for a directory.
          </li>
          <li>
            <strong>Menu items</strong> — Clear plates in order for a PDF menu.
          </li>
          <li>
            <strong>Repair tickets</strong> — Export each part photo as you log it.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After this batch background removal tool, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
