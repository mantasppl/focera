...
const FEATURES = [
  {
    title: "Instant alpha cutout",
    description:
      "AI isolates people, products, and graphics so you get a transparent BG PNG with real alpha — no pen-tool tracing.",
  },
  {
...
export default function TransparentBgSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="transparent-bg-features"
        title="Everything you need for a transparent BG"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          Getting a transparent BG should stay simple: upload once, isolate the
          subject, then download. Focera keeps that path on one page with no
          account.
        </p>
        <ol className="tool-content__steps">
          ...
          <li>
            <strong>Make a transparent BG.</strong> Click Make background
        ...
        <p>
          Jump back to the{" "}
          <a href="#transparent-bg-tool">transparent BG tool</a> anytime to
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Catalog shots</strong> — Lift a bottle, shoe, or gadget off
            a busy table so it sits on a clean listing canvas.
          </li>
          <li>
            <strong>Ads and decks</strong> — Place a person or product on
            posters and slides without leftover walls.
          </li>
          <li>
            <strong>Stories and stickers</strong> — Cut subjects free for
            covers, thumbnails, and outline graphics.
          </li>
          <li>
            <strong>Directory photos</strong> — Prepare headshots that can sit
      ...
      >
        ...
        <p>
          ...
          export a transparent BG, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
