    ...
    <article className="tool-content">
      <section className="tool-content__section" aria-labelledby="what-is-qr">
        ...
        <p>
          ...
          Wi‑Fi login, or vCard. A PDF enters the job in two ways: you
          download the mark as a print-ready PDF, or you encode a link
          that opens a PDF you already host.
        </p>
        <p>
          A <strong>PDF QR code generator</strong> here does both of those
          product jobs. It does not pack a PDF file into the grid. The
          pattern stores a short string; a document lives on a URL you
          control if the scan should open a file.
        </p>
        <p>
      ...
      >
        ...
        <p>
          Print shops want a PDF of the mark. Readers often want a
          brochure, menu, or spec sheet. This page exports a clean PDF of
          the code and can encode a https:// link to a document you host —
          no account, no watermark.
        </p>
        <p>
          Encoding runs in the browser. If the PDF URL needs campaign
        ...
        <p>
          Jump to the{" "}
          <a href="#pdf-qr-code-generator-tool">PDF QR code generator tool</a>{" "}
      ...
      >
        <h2 id="how-to-generate" className="tool-content__heading">
          How to Generate a PDF QR Code in Three Simple Steps
        </h2>
        <p>Payload first, then style, then a PDF download or a link test.</p>
        <ol className="tool-content__steps">
          ...
          <li>
            ...
            output, PNG or SVG for layouts, ZIP for a batch.
          </li>
        </ol>
        <p>
          After export, the{" "}
      ...
      <section className="tool-content__section" aria-labelledby="use-cases">
        ...
        <p>PDF-related codes fit print and document jobs:</p>
        <ul className="tool-content__list">
          <li>
            <strong>Print production</strong> — A PDF of the mark for a
            press or sticker run.
          </li>
          <li>
            <strong>Menus and catalogs</strong> — A scan that opens a
            hosted PDF.
          </li>
          <li>
            <strong>Packaging</strong> — A spec sheet or safety PDF from
            a carton.
          </li>
          <li>
            <strong>Events</strong> — An agenda PDF from a badge or
            poster.
          </li>
          <li>
            <strong>Internal ops</strong> — A procedure PDF on warehouse
            signage.
          </li>
          <li>
            <strong>Courses</strong> — A worksheet PDF from a printed
            handout.
          </li>
        </ul>
        <p>
      ...
      <section className="tool-content__section" aria-labelledby="design-tips">
        ...
        <p>Print PDFs still need contrast and size:</p>
        <ul className="tool-content__list">
        ...
        <p>
          Re-test after you add a logo or change colors.
        </p>
      </section>
      ...
      <section className="tool-content__section" aria-labelledby="privacy">
        ...
        <p>
          Draft URLs and the QR PDF export stay on this device during
          generation. Nothing is uploaded to encode the pattern.
        </p>
        <p>
