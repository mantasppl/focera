...
export default function RemoveWatermark() {
  ...
  return (
    <div className="tool-grid remove-watermark">
      ...
      <div className="tool-panel tool-panel--preview">
          ...
          {loading ? (
            <div className="tool-loading" role="status" aria-live="polite">
              ...
              <span className="tool-loading__text">
                {progressText || "Removing watermark…"}
              </span>
            ...
            <div className="remove-watermark__result">
              <p className="remove-watermark__result-meta">
            ...
            <div className="remove-watermark__paint">
              ...
              <p className="tool-placeholder preview-single__hint">
                Brush over the watermark or logo, then click Remove watermark.
              </p>
            </div>
          ) : (
            <p className="tool-placeholder">
              Upload a photo to mark and remove its watermark
            </p>
          )}
        </div>
        ...
        <p className="tool-hint">
          {hasResult
            ...
            : "Paint the watermark, restore the area in your browser · files never upload to Focera"}
        </p>
      </div>
    </div>
  );
