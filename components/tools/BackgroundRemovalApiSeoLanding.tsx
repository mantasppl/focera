...
const FEATURES = [
  {
    title: "A page instead of a billed API",
    description:
      "There is no URL to POST a file to. Segmentation runs in this tab with an ONNX model.",
  },
  {
...
export default function BackgroundRemovalApiSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="background-removal-api-features"
        title="Everything you need in Background Removal API"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          A background-removal API is a server product. This page is a local tool you open when you want a PNG without integrating one.
        </p>
        <ol className="tool-content__steps">
          ...
          <li>
            <strong>Run local background removal.</strong> Click Make
        ...
        <p>
          Jump back to the{" "}
          <a href="#background-removal-api-tool">
            background removal api tool
          </a>{" "}
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Pre-integration</strong> — See cutout quality before you pick a vendor.
          </li>
          <li>
            <strong>Offline-ish laptops</strong> — Work after the model is cached, without posting images.
          </li>
          <li>
            <strong>Legal reviews</strong> — Avoid sending stills to a third party.
          </li>
          <li>
            <strong>Tiny teams</strong> — Export files without a cloud bill.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After this background-removal API alternative, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
