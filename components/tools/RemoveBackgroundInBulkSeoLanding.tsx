...
const FEATURES = [
  {
    title: "Bulk without a bulk uploader",
    description:
      "In bulk means the same station, over and over, with no signup. Download each PNG before you start the next.",
  },
  {
...
export default function RemoveBackgroundInBulkSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="remove-background-in-bulk-features"
        title="Everything you need in Remove Background in Bulk"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          Removing a background in bulk on Focera is sequential on purpose. Your originals never sit in a remote folder.
        </p>
        <ol className="tool-content__steps">
          ...
          <li>
            <strong>Remove the background in bulk.</strong> Click Make
        ...
        <p>
          Jump back to the{" "}
          <a href="#remove-background-in-bulk-tool">
            remove background in bulk tool
          </a>{" "}
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Shelf resets</strong> — Work an aisle of products in one evening.
          </li>
          <li>
            <strong>Closet listings</strong> — Clear bedrooms behind each garment.
          </li>
          <li>
            <strong>Food menus</strong> — Isolate dishes from a night of plate photos.
          </li>
          <li>
            <strong>Hardware bins</strong> — Export each part as you photograph the drawer.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After you remove a background in bulk, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
