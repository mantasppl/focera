...
const FEATURES = [
  {
    title: "Cutout without a desktop stack",
    description:
      "You get a subject with alpha, plus crop, shadow, and outline — not layers, channels, or a pen-tool workspace.",
  },
  {
...
export default function PhotoshopStyleBackgroundRemoverSeoLanding() {
  return (
    <article className="tool-content">
      <FeatureGrid
        id="photoshop-style-background-remover-features"
        title="Everything you need in Photoshop-Style Background Remover"
        features={FEATURES}
      />
      ...
      >
        ...
        <p>
          A Photoshop-style background remover here means a dedicated cutout page in the browser. Use a full editor when you need composite layers; use this page when you need the isolated PNG.
        </p>
        ...
        <p>
          Jump back to the{" "}
          <a href="#photoshop-style-background-remover-tool">
            photoshop style background remover tool
          </a>{" "}
      ...
      >
        ...
        <ul className="tool-content__list">
          <li>
            <strong>Tight deadlines</strong> — Leave with a PNG when you do not want to open a desktop project.
          </li>
          <li>
            <strong>Simple composites</strong> — Drop a person onto a slide without building a PSD.
          </li>
          <li>
            <strong>Client extracts</strong> — Send a cutout without a layered working file.
          </li>
          <li>
            <strong>Edge checks</strong> — Inspect the split with a slider instead of a mask panel.
          </li>
        </ul>
      </section>
      ...
      >
        ...
        <p>
          Focera groups fast, privacy-friendly utilities in one hub. After this Photoshop-style background remover, these tools often fit the same workflow:
        </p>
        <ul className="tool-content__list">
          <li>
