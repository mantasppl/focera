...
import QrCodeMakerSeoLanding from "@/components/tools/QrCodeMakerSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-maker")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-maker-tool"
          content={<QrCodeMakerSeoLanding />}
