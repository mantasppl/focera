...
import DynamicQrCodeGeneratorSeoLanding from "@/components/tools/DynamicQrCodeGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("dynamic-qr-code-generator")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="dynamic-qr-code-generator-tool"
          content={<DynamicQrCodeGeneratorSeoLanding />}
