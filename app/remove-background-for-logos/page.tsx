...
import RemoveBackgroundForLogosSeoLanding from "@/components/tools/RemoveBackgroundForLogosSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-for-logos")!;
...
export default function RemoveBackgroundForLogosPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-for-logos-tool"
          content={<RemoveBackgroundForLogosSeoLanding />}
