...
import AiBackgroundRemovalApiSeoLanding from "@/components/tools/AiBackgroundRemovalApiSeoLanding";
...
const page = getSeoLandingBySlug("ai-background-removal-api")!;
...
export default function AiBackgroundRemovalApiPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="ai-background-removal-api-tool"
          content={<AiBackgroundRemovalApiSeoLanding />}
