...
import InstantBackgroundRemoverSeoLanding from "@/components/tools/InstantBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("instant-background-remover")!;
...
export default function InstantBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="instant-background-remover-tool"
          content={<InstantBackgroundRemoverSeoLanding />}
