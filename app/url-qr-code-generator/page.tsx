...
import UrlQrCodeGeneratorSeoLanding from "@/components/tools/UrlQrCodeGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("url-qr-code-generator")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="url-qr-code-generator-tool"
          content={<UrlQrCodeGeneratorSeoLanding />}
