...
import RemoveBackgroundMultipleImagesSeoLanding from "@/components/tools/RemoveBackgroundMultipleImagesSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-multiple-images")!;
...
export default function RemoveBackgroundMultipleImagesPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-multiple-images-tool"
          content={<RemoveBackgroundMultipleImagesSeoLanding />}
