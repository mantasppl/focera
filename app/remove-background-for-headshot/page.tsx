...
import RemoveBackgroundForHeadshotSeoLanding from "@/components/tools/RemoveBackgroundForHeadshotSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-for-headshot")!;
...
export default function RemoveBackgroundForHeadshotPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-for-headshot-tool"
          content={<RemoveBackgroundForHeadshotSeoLanding />}
