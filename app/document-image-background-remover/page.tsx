...
import DocumentImageBackgroundRemoverSeoLanding from "@/components/tools/DocumentImageBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("document-image-background-remover")!;
...
export default function DocumentImageBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="document-image-background-remover-tool"
          content={<DocumentImageBackgroundRemoverSeoLanding />}
