...
import QrCodeForGoogleFormSeoLanding from "@/components/tools/QrCodeForGoogleFormSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-for-google-form")!;
...
export default function QrCodeForGoogleFormPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-for-google-form-tool"
          content={<QrCodeForGoogleFormSeoLanding />}
