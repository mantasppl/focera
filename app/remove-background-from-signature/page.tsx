...
import RemoveBackgroundFromSignatureSeoLanding from "@/components/tools/RemoveBackgroundFromSignatureSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-from-signature")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-from-signature-tool"
          content={<RemoveBackgroundFromSignatureSeoLanding />}
