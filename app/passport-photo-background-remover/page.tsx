...
import PassportPhotoBackgroundRemoverSeoLanding from "@/components/tools/PassportPhotoBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("passport-photo-background-remover")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="passport-photo-background-remover-tool"
          content={<PassportPhotoBackgroundRemoverSeoLanding />}
