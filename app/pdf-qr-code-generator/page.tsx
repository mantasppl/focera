...
import PdfQrCodeGeneratorSeoLanding from "@/components/tools/PdfQrCodeGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("pdf-qr-code-generator")!;
...
export default function PdfQrCodeGeneratorPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="pdf-qr-code-generator-tool"
          content={<PdfQrCodeGeneratorSeoLanding />}
