...
import OneClickBackgroundRemoverSeoLanding from "@/components/tools/OneClickBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("one-click-background-remover")!;
...
export default function OneClickBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="one-click-background-remover-tool"
          content={<OneClickBackgroundRemoverSeoLanding />}
