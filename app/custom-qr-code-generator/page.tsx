...
import CustomQrCodeGeneratorSeoLanding from "@/components/tools/CustomQrCodeGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("custom-qr-code-generator")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="custom-qr-code-generator-tool"
          content={<CustomQrCodeGeneratorSeoLanding />}
