...
import MakePictureTransparentSeoLanding from "@/components/tools/MakePictureTransparentSeoLanding";
...
const page = getSeoLandingBySlug("make-picture-transparent")!;
...
export default function MakePictureTransparentPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="make-picture-transparent-tool"
          content={<MakePictureTransparentSeoLanding />}
