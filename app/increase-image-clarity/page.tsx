...
import IncreaseImageClaritySeoLanding from "@/components/tools/IncreaseImageClaritySeoLanding";
...
const page = getSeoLandingBySlug("increase-image-clarity")!;
...
export default function IncreaseImageClarityPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="increase-image-clarity-tool"
          content={<IncreaseImageClaritySeoLanding />}
