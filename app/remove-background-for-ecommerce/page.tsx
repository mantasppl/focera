...
import RemoveBackgroundForEcommerceSeoLanding from "@/components/tools/RemoveBackgroundForEcommerceSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-for-ecommerce")!;
...
export default function RemoveBackgroundForEcommercePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-for-ecommerce-tool"
          content={<RemoveBackgroundForEcommerceSeoLanding />}
