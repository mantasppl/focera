...
import QrCodeGeneratorForPdfDownloadSeoLanding from "@/components/tools/QrCodeGeneratorForPdfDownloadSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-generator-for-pdf-download")!;
...
export default function QrCodeGeneratorForPdfDownloadPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-generator-for-pdf-download-tool"
          content={<QrCodeGeneratorForPdfDownloadSeoLanding />}
