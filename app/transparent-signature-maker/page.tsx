...
import TransparentSignatureMakerSeoLanding from "@/components/tools/TransparentSignatureMakerSeoLanding";
...
const page = getSeoLandingBySlug("transparent-signature-maker")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="transparent-signature-maker-tool"
          content={<TransparentSignatureMakerSeoLanding />}
