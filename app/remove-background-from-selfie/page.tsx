...
import RemoveBackgroundFromSelfieSeoLanding from "@/components/tools/RemoveBackgroundFromSelfieSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-from-selfie")!;
...
export default function RemoveBackgroundFromSelfiePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-from-selfie-tool"
          content={<RemoveBackgroundFromSelfieSeoLanding />}
