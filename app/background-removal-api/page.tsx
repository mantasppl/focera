...
import BackgroundRemovalApiSeoLanding from "@/components/tools/BackgroundRemovalApiSeoLanding";
...
const page = getSeoLandingBySlug("background-removal-api")!;
...
export default function BackgroundRemovalApiPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="background-removal-api-tool"
          content={<BackgroundRemovalApiSeoLanding />}
