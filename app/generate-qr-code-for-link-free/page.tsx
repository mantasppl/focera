...
import GenerateQrCodeForLinkFreeSeoLanding from "@/components/tools/GenerateQrCodeForLinkFreeSeoLanding";
...
const page = getSeoLandingBySlug("generate-qr-code-for-link-free")!;
...
export default function GenerateQrCodeForLinkFreePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="generate-qr-code-for-link-free-tool"
          content={<GenerateQrCodeForLinkFreeSeoLanding />}
