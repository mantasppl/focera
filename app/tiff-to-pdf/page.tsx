...
import TiffToPdfLanding from "@/components/tools/TiffToPdfLanding";
import { TiffToPdfLazy } from "@/components/tools/HeavyTools";
...
export default function TiffToPdfPage() {
  ...
  return (
    <>
      ...
      <ToolPageShell
        slug="tiff-to-pdf"
        workspaceId="tiff-to-pdf-tool"
        content={<TiffToPdfLanding />}
