...
import InstantPhotoBackgroundRemovalSeoLanding from "@/components/tools/InstantPhotoBackgroundRemovalSeoLanding";
...
const page = getSeoLandingBySlug("instant-photo-background-removal")!;
...
export default function InstantPhotoBackgroundRemovalPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="instant-photo-background-removal-tool"
          content={<InstantPhotoBackgroundRemovalSeoLanding />}
