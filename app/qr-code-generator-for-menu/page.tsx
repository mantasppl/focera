...
import QrCodeGeneratorForMenuSeoLanding from "@/components/tools/QrCodeGeneratorForMenuSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-generator-for-menu")!;
...
export default function QrCodeGeneratorForMenuPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-generator-for-menu-tool"
          content={<QrCodeGeneratorForMenuSeoLanding />}
