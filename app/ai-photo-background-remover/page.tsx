...
import AiPhotoBackgroundRemoverSeoLanding from "@/components/tools/AiPhotoBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("ai-photo-background-remover")!;
...
export default function AiPhotoBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="ai-photo-background-remover-tool"
          content={<AiPhotoBackgroundRemoverSeoLanding />}
