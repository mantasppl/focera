...
import PortraitBackgroundRemoverSeoLanding from "@/components/tools/PortraitBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("portrait-background-remover")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="portrait-background-remover-tool"
          content={<PortraitBackgroundRemoverSeoLanding />}
