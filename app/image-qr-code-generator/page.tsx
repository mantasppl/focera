...
import ImageQrCodeGeneratorSeoLanding from "@/components/tools/ImageQrCodeGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("image-qr-code-generator")!;
...
export default function ImageQrCodeGeneratorPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="image-qr-code-generator-tool"
          content={<ImageQrCodeGeneratorSeoLanding />}
