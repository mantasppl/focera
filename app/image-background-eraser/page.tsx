...
import ImageBackgroundEraserSeoLanding from "@/components/tools/ImageBackgroundEraserSeoLanding";
...
const page = getSeoLandingBySlug("image-background-eraser")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="image-background-eraser-tool"
          content={<ImageBackgroundEraserSeoLanding />}
