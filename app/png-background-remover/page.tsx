...
import PngBackgroundRemoverSeoLanding from "@/components/tools/PngBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("png-background-remover")!;
...
export default function PngBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="png-background-remover-tool"
          content={<PngBackgroundRemoverSeoLanding />}
