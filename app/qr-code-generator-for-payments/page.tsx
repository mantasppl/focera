...
import QrCodeGeneratorForPaymentsSeoLanding from "@/components/tools/QrCodeGeneratorForPaymentsSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-generator-for-payments")!;
...
export default function QrCodeGeneratorForPaymentsPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-generator-for-payments-tool"
          content={<QrCodeGeneratorForPaymentsSeoLanding />}
