...
import AiPhotoSharpenerSeoLanding from "@/components/tools/AiPhotoSharpenerSeoLanding";
...
const page = getSeoLandingBySlug("ai-photo-sharpener")!;
...
export default function AiPhotoSharpenerPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="ai-photo-sharpener-tool"
          content={<AiPhotoSharpenerSeoLanding />}
