...
import SocialMediaBackgroundRemoverSeoLanding from "@/components/tools/SocialMediaBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("social-media-background-remover")!;
...
export default function SocialMediaBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="social-media-background-remover-tool"
          content={<SocialMediaBackgroundRemoverSeoLanding />}
