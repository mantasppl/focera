...
import TransparentBgSeoLanding from "@/components/tools/TransparentBgSeoLanding";
...
const page = getSeoLandingBySlug("transparent-bg")!;
...
export default function TransparentBgPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="transparent-bg-tool"
          content={<TransparentBgSeoLanding />}
