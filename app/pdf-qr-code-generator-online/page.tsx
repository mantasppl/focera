...
import PdfQrCodeGeneratorOnlineSeoLanding from "@/components/tools/PdfQrCodeGeneratorOnlineSeoLanding";
...
const page = getSeoLandingBySlug("pdf-qr-code-generator-online")!;
...
export default function PdfQrCodeGeneratorOnlinePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="pdf-qr-code-generator-online-tool"
          content={<PdfQrCodeGeneratorOnlineSeoLanding />}
