...
import CleanBackgroundFromDocImageSeoLanding from "@/components/tools/CleanBackgroundFromDocImageSeoLanding";
...
const page = getSeoLandingBySlug("clean-background-from-doc-image")!;
...
export default function CleanBackgroundFromDocImagePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="clean-background-from-doc-image-tool"
          content={<CleanBackgroundFromDocImageSeoLanding />}
