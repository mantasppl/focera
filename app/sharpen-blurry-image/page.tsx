...
import SharpenBlurryImageSeoLanding from "@/components/tools/SharpenBlurryImageSeoLanding";
...
const page = getSeoLandingBySlug("sharpen-blurry-image")!;
...
export default function SharpenBlurryImagePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="sharpen-blurry-image-tool"
          content={<SharpenBlurryImageSeoLanding />}
