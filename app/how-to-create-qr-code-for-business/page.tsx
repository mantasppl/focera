...
import HowToCreateQrCodeForBusinessSeoLanding from "@/components/tools/HowToCreateQrCodeForBusinessSeoLanding";
...
const page = getSeoLandingBySlug("how-to-create-qr-code-for-business")!;
...
export default function HowToCreateQrCodeForBusinessPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="how-to-create-qr-code-for-business-tool"
          content={<HowToCreateQrCodeForBusinessSeoLanding />}
