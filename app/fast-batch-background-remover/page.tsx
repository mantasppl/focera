...
import FastBatchBackgroundRemoverSeoLanding from "@/components/tools/FastBatchBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("fast-batch-background-remover")!;
...
export default function FastBatchBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="fast-batch-background-remover-tool"
          content={<FastBatchBackgroundRemoverSeoLanding />}
