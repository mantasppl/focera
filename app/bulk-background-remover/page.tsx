...
import BulkBackgroundRemoverSeoLanding from "@/components/tools/BulkBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("bulk-background-remover")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="bulk-background-remover-tool"
          content={<BulkBackgroundRemoverSeoLanding />}
