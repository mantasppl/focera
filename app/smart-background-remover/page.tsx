...
import SmartBackgroundRemoverSeoLanding from "@/components/tools/SmartBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("smart-background-remover")!;
...
export default function SmartBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="smart-background-remover-tool"
          content={<SmartBackgroundRemoverSeoLanding />}
