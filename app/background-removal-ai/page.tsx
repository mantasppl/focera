...
import BackgroundRemovalAiSeoLanding from "@/components/tools/BackgroundRemovalAiSeoLanding";
...
const page = getSeoLandingBySlug("background-removal-ai")!;
...
export default function BackgroundRemovalAiPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="background-removal-ai-tool"
          content={<BackgroundRemovalAiSeoLanding />}
