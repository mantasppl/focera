...
import BackgroundRemoverNoSignupSeoLanding from "@/components/tools/BackgroundRemoverNoSignupSeoLanding";
...
const page = getSeoLandingBySlug("background-remover-no-signup")!;
...
export default function BackgroundRemoverNoSignupPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="background-remover-no-signup-tool"
          content={<BackgroundRemoverNoSignupSeoLanding />}
