...
import HighQualityBackgroundRemovalSeoLanding from "@/components/tools/HighQualityBackgroundRemovalSeoLanding";
...
const page = getSeoLandingBySlug("high-quality-background-removal")!;
...
export default function HighQualityBackgroundRemovalPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="high-quality-background-removal-tool"
          content={<HighQualityBackgroundRemovalSeoLanding />}
