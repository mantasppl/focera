...
import TiktokImageBackgroundRemoverSeoLanding from "@/components/tools/TiktokImageBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("tiktok-image-background-remover")!;
...
export default function TiktokImageBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="tiktok-image-background-remover-tool"
          content={<TiktokImageBackgroundRemoverSeoLanding />}
