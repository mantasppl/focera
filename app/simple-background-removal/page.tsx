...
import SimpleBackgroundRemovalSeoLanding from "@/components/tools/SimpleBackgroundRemovalSeoLanding";
...
const page = getSeoLandingBySlug("simple-background-removal")!;
...
export default function SimpleBackgroundRemovalPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="simple-background-removal-tool"
          content={<SimpleBackgroundRemovalSeoLanding />}
