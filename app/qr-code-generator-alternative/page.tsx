...
import QrCodeGeneratorAlternativeSeoLanding from "@/components/tools/QrCodeGeneratorAlternativeSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-generator-alternative")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-generator-alternative-tool"
          content={<QrCodeGeneratorAlternativeSeoLanding />}
