...
import ImageUnblurToolSeoLanding from "@/components/tools/ImageUnblurToolSeoLanding";
...
const page = getSeoLandingBySlug("image-unblur-tool")!;
...
export default function ImageUnblurToolPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="image-unblur-tool-tool"
          content={<ImageUnblurToolSeoLanding />}
