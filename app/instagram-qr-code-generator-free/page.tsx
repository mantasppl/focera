...
import InstagramQrCodeGeneratorFreeSeoLanding from "@/components/tools/InstagramQrCodeGeneratorFreeSeoLanding";
...
const page = getSeoLandingBySlug("instagram-qr-code-generator-free")!;
...
export default function InstagramQrCodeGeneratorFreePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="instagram-qr-code-generator-free-tool"
          content={<InstagramQrCodeGeneratorFreeSeoLanding />}
