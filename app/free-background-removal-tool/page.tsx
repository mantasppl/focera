...
import FreeBackgroundRemovalToolSeoLanding from "@/components/tools/FreeBackgroundRemovalToolSeoLanding";
...
const page = getSeoLandingBySlug("free-background-removal-tool")!;
...
export default function FreeBackgroundRemovalToolPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="free-background-removal-tool-tool"
          content={<FreeBackgroundRemovalToolSeoLanding />}
