...
import RemoveBackgroundForIdPhotoSeoLanding from "@/components/tools/RemoveBackgroundForIdPhotoSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-for-id-photo")!;
...
export default function RemoveBackgroundForIdPhotoPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-for-id-photo-tool"
          content={<RemoveBackgroundForIdPhotoSeoLanding />}
