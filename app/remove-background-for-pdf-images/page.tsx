...
import RemoveBackgroundForPdfImagesSeoLanding from "@/components/tools/RemoveBackgroundForPdfImagesSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-for-pdf-images")!;
...
export default function RemoveBackgroundForPdfImagesPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-for-pdf-images-tool"
          content={<RemoveBackgroundForPdfImagesSeoLanding />}
