...
import TransparentImageGeneratorSeoLanding from "@/components/tools/TransparentImageGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("transparent-image-generator")!;
...
export default function TransparentImageGeneratorPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="transparent-image-generator-tool"
          content={<TransparentImageGeneratorSeoLanding />}
