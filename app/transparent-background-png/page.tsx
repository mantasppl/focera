...
import TransparentBackgroundPngSeoLanding from "@/components/tools/TransparentBackgroundPngSeoLanding";
...
const page = getSeoLandingBySlug("transparent-background-png")!;
...
export default function TransparentBackgroundPngPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="transparent-background-png-tool"
          content={<TransparentBackgroundPngSeoLanding />}
