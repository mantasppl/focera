...
import RemoveBackgroundFreeHdSeoLanding from "@/components/tools/RemoveBackgroundFreeHdSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-free-hd")!;
...
export default function RemoveBackgroundFreeHdPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-free-hd-tool"
          content={<RemoveBackgroundFreeHdSeoLanding />}
