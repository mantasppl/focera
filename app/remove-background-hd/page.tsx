...
import RemoveBackgroundHdSeoLanding from "@/components/tools/RemoveBackgroundHdSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-hd")!;
...
export default function RemoveBackgroundHdPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-hd-tool"
          content={<RemoveBackgroundHdSeoLanding />}
