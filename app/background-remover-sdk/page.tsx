...
import BackgroundRemoverSdkSeoLanding from "@/components/tools/BackgroundRemoverSdkSeoLanding";
...
const page = getSeoLandingBySlug("background-remover-sdk")!;
...
export default function BackgroundRemoverSdkPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="background-remover-sdk-tool"
          content={<BackgroundRemoverSdkSeoLanding />}
