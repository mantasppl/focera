...
import RemoveBackgroundForDesignSeoLanding from "@/components/tools/RemoveBackgroundForDesignSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-for-design")!;
...
export default function RemoveBackgroundForDesignPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-for-design-tool"
          content={<RemoveBackgroundForDesignSeoLanding />}
