...
import QrCodeGeneratorVsCanvaSeoLanding from "@/components/tools/QrCodeGeneratorVsCanvaSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-generator-vs-canva")!;
...
export default function QrCodeGeneratorVsCanvaPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-generator-vs-canva-tool"
          content={<QrCodeGeneratorVsCanvaSeoLanding />}
