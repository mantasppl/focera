...
import BatchImageCleanerSeoLanding from "@/components/tools/BatchImageCleanerSeoLanding";
...
const page = getSeoLandingBySlug("batch-image-cleaner")!;
...
export default function BatchImageCleanerPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="batch-image-cleaner-tool"
          content={<BatchImageCleanerSeoLanding />}
