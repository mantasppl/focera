...
import MakeImageClearOnlineSeoLanding from "@/components/tools/MakeImageClearOnlineSeoLanding";
...
const page = getSeoLandingBySlug("make-image-clear-online")!;
...
export default function MakeImageClearOnlinePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="make-image-clear-online-tool"
          content={<MakeImageClearOnlineSeoLanding />}
