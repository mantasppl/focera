...
import DesignImageBackgroundRemovalSeoLanding from "@/components/tools/DesignImageBackgroundRemovalSeoLanding";
...
const page = getSeoLandingBySlug("design-image-background-removal")!;
...
export default function DesignImageBackgroundRemovalPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="design-image-background-removal-tool"
          content={<DesignImageBackgroundRemovalSeoLanding />}
