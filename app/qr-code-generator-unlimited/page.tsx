...
import QrCodeGeneratorUnlimitedSeoLanding from "@/components/tools/QrCodeGeneratorUnlimitedSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-generator-unlimited")!;
...
export default function QrCodeGeneratorUnlimitedPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-generator-unlimited-tool"
          content={<QrCodeGeneratorUnlimitedSeoLanding />}
