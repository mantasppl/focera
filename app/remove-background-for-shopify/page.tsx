...
import RemoveBackgroundForShopifySeoLanding from "@/components/tools/RemoveBackgroundForShopifySeoLanding";
...
const page = getSeoLandingBySlug("remove-background-for-shopify")!;
...
export default function RemoveBackgroundForShopifyPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-for-shopify-tool"
          content={<RemoveBackgroundForShopifySeoLanding />}
