...
import RemoveImageBackgroundSeoLanding from "@/components/tools/RemoveImageBackgroundSeoLanding";
...
const page = getSeoLandingBySlug("remove-image-background")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-image-background-tool"
          content={<RemoveImageBackgroundSeoLanding />}
