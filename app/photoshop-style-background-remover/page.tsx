...
import PhotoshopStyleBackgroundRemoverSeoLanding from "@/components/tools/PhotoshopStyleBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("photoshop-style-background-remover")!;
...
export default function PhotoshopStyleBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="photoshop-style-background-remover-tool"
          content={<PhotoshopStyleBackgroundRemoverSeoLanding />}
