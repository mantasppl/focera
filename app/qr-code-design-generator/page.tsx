...
import QrCodeDesignGeneratorSeoLanding from "@/components/tools/QrCodeDesignGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-design-generator")!;
...
export default function QrCodeDesignGeneratorPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-design-generator-tool"
          content={<QrCodeDesignGeneratorSeoLanding />}
