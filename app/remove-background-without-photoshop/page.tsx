...
import RemoveBackgroundWithoutPhotoshopSeoLanding from "@/components/tools/RemoveBackgroundWithoutPhotoshopSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-without-photoshop")!;
...
export default function RemoveBackgroundWithoutPhotoshopPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-without-photoshop-tool"
          content={<RemoveBackgroundWithoutPhotoshopSeoLanding />}
