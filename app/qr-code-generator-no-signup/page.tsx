...
import QrCodeGeneratorNoSignupSeoLanding from "@/components/tools/QrCodeGeneratorNoSignupSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-generator-no-signup")!;
...
export default function QrCodeGeneratorNoSignupPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-generator-no-signup-tool"
          content={<QrCodeGeneratorNoSignupSeoLanding />}
