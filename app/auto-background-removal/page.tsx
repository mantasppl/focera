...
import AutoBackgroundRemovalSeoLanding from "@/components/tools/AutoBackgroundRemovalSeoLanding";
...
const page = getSeoLandingBySlug("auto-background-removal")!;
...
export default function AutoBackgroundRemovalPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="auto-background-removal-tool"
          content={<AutoBackgroundRemovalSeoLanding />}
