...
import BestQrCodeGeneratorSeoLanding from "@/components/tools/BestQrCodeGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("best-qr-code-generator")!;
...
export default function BestQrCodeGeneratorPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="best-qr-code-generator-tool"
          content={<BestQrCodeGeneratorSeoLanding />}
