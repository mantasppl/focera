...
import AiFixBlurryPhotosSeoLanding from "@/components/tools/AiFixBlurryPhotosSeoLanding";
...
const page = getSeoLandingBySlug("ai-fix-blurry-photos")!;
...
export default function AiFixBlurryPhotosPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="ai-fix-blurry-photos-tool"
          content={<AiFixBlurryPhotosSeoLanding />}
