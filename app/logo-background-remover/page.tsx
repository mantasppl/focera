...
import LogoBackgroundRemoverSeoLanding from "@/components/tools/LogoBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("logo-background-remover")!;
...
export default function LogoBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="logo-background-remover-tool"
          content={<LogoBackgroundRemoverSeoLanding />}
