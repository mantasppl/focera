...
import CreateQrCodeForWebsiteFreeSeoLanding from "@/components/tools/CreateQrCodeForWebsiteFreeSeoLanding";
...
const page = getSeoLandingBySlug("create-qr-code-for-website-free")!;
...
export default function CreateQrCodeForWebsiteFreePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="create-qr-code-for-website-free-tool"
          content={<CreateQrCodeForWebsiteFreeSeoLanding />}
