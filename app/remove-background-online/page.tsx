...
import RemoveBackgroundOnlineSeoLanding from "@/components/tools/RemoveBackgroundOnlineSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-online")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-online-tool"
          content={<RemoveBackgroundOnlineSeoLanding />}
