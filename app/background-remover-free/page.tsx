...
import BackgroundRemoverFreeSeoLanding from "@/components/tools/BackgroundRemoverFreeSeoLanding";
...
const page = getSeoLandingBySlug("background-remover-free")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="background-remover-free-tool"
          content={<BackgroundRemoverFreeSeoLanding />}
