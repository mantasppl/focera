...
import BackgroundTransparentSeoLanding from "@/components/tools/BackgroundTransparentSeoLanding";
...
const page = getSeoLandingBySlug("background-transparent")!;
...
export default function BackgroundTransparentPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="background-transparent-tool"
          content={<BackgroundTransparentSeoLanding />}
