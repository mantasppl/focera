...
import BackgroundRemoverForImagesSeoLanding from "@/components/tools/BackgroundRemoverForImagesSeoLanding";
...
const page = getSeoLandingBySlug("background-remover-for-images")!;
...
export default function BackgroundRemoverForImagesPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="background-remover-for-images-tool"
          content={<BackgroundRemoverForImagesSeoLanding />}
