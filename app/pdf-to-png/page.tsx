...
import PdfToPngLanding from "@/components/tools/PdfToPngLanding";
import { PdfToPngLazy } from "@/components/tools/HeavyTools";
...
export default function PdfToPngPage() {
  ...
  return (
    <>
      ...
      <ToolPageShell
        slug="pdf-to-png"
        workspaceId="pdf-to-png-tool"
        content={<PdfToPngLanding />}
