...
import RemoveBackgroundFromScanSeoLanding from "@/components/tools/RemoveBackgroundFromScanSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-from-scan")!;
...
export default function RemoveBackgroundFromScanPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-from-scan-tool"
          content={<RemoveBackgroundFromScanSeoLanding />}
