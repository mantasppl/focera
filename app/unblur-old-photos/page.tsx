...
import UnblurOldPhotosSeoLanding from "@/components/tools/UnblurOldPhotosSeoLanding";
...
const page = getSeoLandingBySlug("unblur-old-photos")!;
...
export default function UnblurOldPhotosPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="unblur-old-photos-tool"
          content={<UnblurOldPhotosSeoLanding />}
