...
import QrCodeGeneratorForBusinessSeoLanding from "@/components/tools/QrCodeGeneratorForBusinessSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-generator-for-business")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-generator-for-business-tool"
          content={<QrCodeGeneratorForBusinessSeoLanding />}
