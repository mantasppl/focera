...
import FreeImageBackgroundRemoverSeoLanding from "@/components/tools/FreeImageBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("free-image-background-remover")!;
...
export default function FreeImageBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="free-image-background-remover-tool"
          content={<FreeImageBackgroundRemoverSeoLanding />}
