...
import QuickBackgroundRemoverSeoLanding from "@/components/tools/QuickBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("quick-background-remover")!;
...
export default function QuickBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="quick-background-remover-tool"
          content={<QuickBackgroundRemoverSeoLanding />}
