...
import InstagramPhotoBackgroundRemoverSeoLanding from "@/components/tools/InstagramPhotoBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("instagram-photo-background-remover")!;
...
export default function InstagramPhotoBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="instagram-photo-background-remover-tool"
          content={<InstagramPhotoBackgroundRemoverSeoLanding />}
