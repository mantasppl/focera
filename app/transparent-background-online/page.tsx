...
import TransparentBackgroundOnlineSeoLanding from "@/components/tools/TransparentBackgroundOnlineSeoLanding";
...
const page = getSeoLandingBySlug("transparent-background-online")!;
...
export default function TransparentBackgroundOnlinePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="transparent-background-online-tool"
          content={<TransparentBackgroundOnlineSeoLanding />}
