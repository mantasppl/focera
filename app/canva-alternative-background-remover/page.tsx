...
import CanvaAlternativeBackgroundRemoverSeoLanding from "@/components/tools/CanvaAlternativeBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("canva-alternative-background-remover")!;
...
export default function CanvaAlternativeBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="canva-alternative-background-remover-tool"
          content={<CanvaAlternativeBackgroundRemoverSeoLanding />}
