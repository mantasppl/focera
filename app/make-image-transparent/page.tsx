...
import MakeImageTransparentSeoLanding from "@/components/tools/MakeImageTransparentSeoLanding";
...
const page = getSeoLandingBySlug("make-image-transparent")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="make-image-transparent-tool"
          content={<MakeImageTransparentSeoLanding />}
