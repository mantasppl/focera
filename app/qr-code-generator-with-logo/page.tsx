...
import QrCodeGeneratorWithLogoSeoLanding from "@/components/tools/QrCodeGeneratorWithLogoSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-generator-with-logo")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-generator-with-logo-tool"
          content={<QrCodeGeneratorWithLogoSeoLanding />}
