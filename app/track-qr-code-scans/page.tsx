...
import TrackQrCodeScansSeoLanding from "@/components/tools/TrackQrCodeScansSeoLanding";
...
const page = getSeoLandingBySlug("track-qr-code-scans")!;
...
export default function TrackQrCodeScansPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="track-qr-code-scans-tool"
          content={<TrackQrCodeScansSeoLanding />}
