...
import PngToWebpLanding from "@/components/tools/PngToWebpLanding";
import { PngToWebpLazy } from "@/components/tools/HeavyTools";
...
export default function PngToWebpPage() {
  ...
  return (
    <>
      ...
      <ToolPageShell
        slug="png-to-webp"
        workspaceId="png-to-webp-tool"
        content={<PngToWebpLanding />}
