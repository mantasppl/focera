...
import MassBackgroundRemovalToolSeoLanding from "@/components/tools/MassBackgroundRemovalToolSeoLanding";
...
const page = getSeoLandingBySlug("mass-background-removal-tool")!;
...
export default function MassBackgroundRemovalToolPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="mass-background-removal-tool-tool"
          content={<MassBackgroundRemovalToolSeoLanding />}
