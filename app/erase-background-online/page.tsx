...
import EraseBackgroundOnlineSeoLanding from "@/components/tools/EraseBackgroundOnlineSeoLanding";
...
const page = getSeoLandingBySlug("erase-background-online")!;
...
export default function EraseBackgroundOnlinePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="erase-background-online-tool"
          content={<EraseBackgroundOnlineSeoLanding />}
