...
import ImageProcessingBackgroundRemovalSeoLanding from "@/components/tools/ImageProcessingBackgroundRemovalSeoLanding";
...
const page = getSeoLandingBySlug("image-processing-background-removal")!;
...
export default function ImageProcessingBackgroundRemovalPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="image-processing-background-removal-tool"
          content={<ImageProcessingBackgroundRemovalSeoLanding />}
