...
import EcommerceImageBackgroundRemovalSeoLanding from "@/components/tools/EcommerceImageBackgroundRemovalSeoLanding";
...
const page = getSeoLandingBySlug("ecommerce-image-background-removal")!;
...
export default function EcommerceImageBackgroundRemovalPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="ecommerce-image-background-removal-tool"
          content={<EcommerceImageBackgroundRemovalSeoLanding />}
