...
import AiBatchBackgroundRemoverSeoLanding from "@/components/tools/AiBatchBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("ai-batch-background-remover")!;
...
export default function AiBatchBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="ai-batch-background-remover-tool"
          content={<AiBatchBackgroundRemoverSeoLanding />}
