...
import AiBackgroundRemoverSeoLanding from "@/components/tools/AiBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("ai-background-remover")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="ai-background-remover-tool"
          content={<AiBackgroundRemoverSeoLanding />}
