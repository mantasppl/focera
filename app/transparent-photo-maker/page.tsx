...
import TransparentPhotoMakerSeoLanding from "@/components/tools/TransparentPhotoMakerSeoLanding";
...
const page = getSeoLandingBySlug("transparent-photo-maker")!;
...
export default function TransparentPhotoMakerPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="transparent-photo-maker-tool"
          content={<TransparentPhotoMakerSeoLanding />}
