...
import BulkImageBackgroundRemovalSeoLanding from "@/components/tools/BulkImageBackgroundRemovalSeoLanding";
...
const page = getSeoLandingBySlug("bulk-image-background-removal")!;
...
export default function BulkImageBackgroundRemovalPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="bulk-image-background-removal-tool"
          content={<BulkImageBackgroundRemovalSeoLanding />}
