...
import DeblurImageOnlineSeoLanding from "@/components/tools/DeblurImageOnlineSeoLanding";
...
const page = getSeoLandingBySlug("deblur-image-online")!;
...
export default function DeblurImageOnlinePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="deblur-image-online-tool"
          content={<DeblurImageOnlineSeoLanding />}
