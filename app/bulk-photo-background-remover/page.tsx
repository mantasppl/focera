...
import BulkPhotoBackgroundRemoverSeoLanding from "@/components/tools/BulkPhotoBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("bulk-photo-background-remover")!;
...
export default function BulkPhotoBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="bulk-photo-background-remover-tool"
          content={<BulkPhotoBackgroundRemoverSeoLanding />}
