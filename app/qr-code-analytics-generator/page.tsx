...
import QrCodeAnalyticsGeneratorSeoLanding from "@/components/tools/QrCodeAnalyticsGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-analytics-generator")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-analytics-generator-tool"
          content={<QrCodeAnalyticsGeneratorSeoLanding />}
