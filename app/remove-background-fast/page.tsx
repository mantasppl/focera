...
import RemoveBackgroundFastSeoLanding from "@/components/tools/RemoveBackgroundFastSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-fast")!;
...
export default function RemoveBackgroundFastPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-fast-tool"
          content={<RemoveBackgroundFastSeoLanding />}
