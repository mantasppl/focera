...
import DynamicQrCodeGeneratorFreeSeoLanding from "@/components/tools/DynamicQrCodeGeneratorFreeSeoLanding";
...
const page = getSeoLandingBySlug("dynamic-qr-code-generator-free")!;
...
export default function DynamicQrCodeGeneratorFreePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="dynamic-qr-code-generator-free-tool"
          content={<DynamicQrCodeGeneratorFreeSeoLanding />}
