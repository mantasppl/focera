...
import RemoveBackgroundProgrammaticallySeoLanding from "@/components/tools/RemoveBackgroundProgrammaticallySeoLanding";
...
const page = getSeoLandingBySlug("remove-background-programmatically")!;
...
export default function RemoveBackgroundProgrammaticallyPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-programmatically-tool"
          content={<RemoveBackgroundProgrammaticallySeoLanding />}
