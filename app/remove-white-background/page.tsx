...
import RemoveWhiteBackgroundSeoLanding from "@/components/tools/RemoveWhiteBackgroundSeoLanding";
...
const page = getSeoLandingBySlug("remove-white-background")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-white-background-tool"
          content={<RemoveWhiteBackgroundSeoLanding />}
