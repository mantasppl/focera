...
import ProBackgroundRemoverToolSeoLanding from "@/components/tools/ProBackgroundRemoverToolSeoLanding";
...
const page = getSeoLandingBySlug("pro-background-remover-tool")!;
...
export default function ProBackgroundRemoverToolPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="pro-background-remover-tool-tool"
          content={<ProBackgroundRemoverToolSeoLanding />}
