...
import TransparentBackgroundForDesignSeoLanding from "@/components/tools/TransparentBackgroundForDesignSeoLanding";
...
const page = getSeoLandingBySlug("transparent-background-for-design")!;
...
export default function TransparentBackgroundForDesignPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="transparent-background-for-design-tool"
          content={<TransparentBackgroundForDesignSeoLanding />}
