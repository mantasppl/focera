...
import BatchBackgroundRemovalToolSeoLanding from "@/components/tools/BatchBackgroundRemovalToolSeoLanding";
...
const page = getSeoLandingBySlug("batch-background-removal-tool")!;
...
export default function BatchBackgroundRemovalToolPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="batch-background-removal-tool-tool"
          content={<BatchBackgroundRemovalToolSeoLanding />}
