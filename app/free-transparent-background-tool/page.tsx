...
import FreeTransparentBackgroundToolSeoLanding from "@/components/tools/FreeTransparentBackgroundToolSeoLanding";
...
const page = getSeoLandingBySlug("free-transparent-background-tool")!;
...
export default function FreeTransparentBackgroundToolPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="free-transparent-background-tool-tool"
          content={<FreeTransparentBackgroundToolSeoLanding />}
