...
import QrCodeGeneratorForInstagramLinkSeoLanding from "@/components/tools/QrCodeGeneratorForInstagramLinkSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-generator-for-instagram-link")!;
...
export default function QrCodeGeneratorForInstagramLinkPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-generator-for-instagram-link-tool"
          content={<QrCodeGeneratorForInstagramLinkSeoLanding />}
