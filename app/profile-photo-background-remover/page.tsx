...
import ProfilePhotoBackgroundRemoverSeoLanding from "@/components/tools/ProfilePhotoBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("profile-photo-background-remover")!;
...
export default function ProfilePhotoBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="profile-photo-background-remover-tool"
          content={<ProfilePhotoBackgroundRemoverSeoLanding />}
