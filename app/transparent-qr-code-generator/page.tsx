...
import TransparentQrCodeGeneratorSeoLanding from "@/components/tools/TransparentQrCodeGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("transparent-qr-code-generator")!;
...
export default function TransparentQrCodeGeneratorPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="transparent-qr-code-generator-tool"
          content={<TransparentQrCodeGeneratorSeoLanding />}
