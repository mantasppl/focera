...
import QrCodeGeneratorWithoutLoginSeoLanding from "@/components/tools/QrCodeGeneratorWithoutLoginSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-generator-without-login")!;
...
export default function QrCodeGeneratorWithoutLoginPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-generator-without-login-tool"
          content={<QrCodeGeneratorWithoutLoginSeoLanding />}
