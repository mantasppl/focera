...
import RemoveBackgroundPngMakerSeoLanding from "@/components/tools/RemoveBackgroundPngMakerSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-png-maker")!;
...
export default function RemoveBackgroundPngMakerPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-png-maker-tool"
          content={<RemoveBackgroundPngMakerSeoLanding />}
