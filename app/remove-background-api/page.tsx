...
import RemoveBackgroundApiSeoLanding from "@/components/tools/RemoveBackgroundApiSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-api")!;
...
export default function RemoveBackgroundApiPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-api-tool"
          content={<RemoveBackgroundApiSeoLanding />}
