...
import WifiQrCodeGeneratorSeoLanding from "@/components/tools/WifiQrCodeGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("wifi-qr-code-generator")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="wifi-qr-code-generator-tool"
          content={<WifiQrCodeGeneratorSeoLanding />}
