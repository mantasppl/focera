...
import BestBackgroundRemoverSeoLanding from "@/components/tools/BestBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("best-background-remover")!;
...
export default function BestBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="best-background-remover-tool"
          content={<BestBackgroundRemoverSeoLanding />}
