...
import QrCodeBuilderSeoLanding from "@/components/tools/QrCodeBuilderSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-builder")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-builder-tool"
          content={<QrCodeBuilderSeoLanding />}
