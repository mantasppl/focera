...
import DeveloperBackgroundRemovalToolSeoLanding from "@/components/tools/DeveloperBackgroundRemovalToolSeoLanding";
...
const page = getSeoLandingBySlug("developer-background-removal-tool")!;
...
export default function DeveloperBackgroundRemovalToolPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="developer-background-removal-tool-tool"
          content={<DeveloperBackgroundRemovalToolSeoLanding />}
