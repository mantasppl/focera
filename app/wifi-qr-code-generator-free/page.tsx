...
import WifiQrCodeGeneratorFreeSeoLanding from "@/components/tools/WifiQrCodeGeneratorFreeSeoLanding";
...
const page = getSeoLandingBySlug("wifi-qr-code-generator-free")!;
...
export default function WifiQrCodeGeneratorFreePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="wifi-qr-code-generator-free-tool"
          content={<WifiQrCodeGeneratorFreeSeoLanding />}
