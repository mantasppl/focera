...
import GenerateQrCodeSeoLanding from "@/components/tools/GenerateQrCodeSeoLanding";
...
const page = getSeoLandingBySlug("generate-qr-code")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="generate-qr-code-tool"
          content={<GenerateQrCodeSeoLanding />}
