...
import TransparentAvatarMakerSeoLanding from "@/components/tools/TransparentAvatarMakerSeoLanding";
...
const page = getSeoLandingBySlug("transparent-avatar-maker")!;
...
export default function TransparentAvatarMakerPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="transparent-avatar-maker-tool"
          content={<TransparentAvatarMakerSeoLanding />}
