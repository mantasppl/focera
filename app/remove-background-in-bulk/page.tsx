...
import RemoveBackgroundInBulkSeoLanding from "@/components/tools/RemoveBackgroundInBulkSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-in-bulk")!;
...
export default function RemoveBackgroundInBulkPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-in-bulk-tool"
          content={<RemoveBackgroundInBulkSeoLanding />}
