...
import RemoveBackgroundForListingsSeoLanding from "@/components/tools/RemoveBackgroundForListingsSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-for-listings")!;
...
export default function RemoveBackgroundForListingsPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-for-listings-tool"
          content={<RemoveBackgroundForListingsSeoLanding />}
