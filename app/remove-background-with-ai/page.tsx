...
import RemoveBackgroundWithAiSeoLanding from "@/components/tools/RemoveBackgroundWithAiSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-with-ai")!;
...
export default function RemoveBackgroundWithAiPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-with-ai-tool"
          content={<RemoveBackgroundWithAiSeoLanding />}
