...
import BackgroundRemoverForProductsSeoLanding from "@/components/tools/BackgroundRemoverForProductsSeoLanding";
...
const page = getSeoLandingBySlug("background-remover-for-products")!;
...
export default function BackgroundRemoverForProductsPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="background-remover-for-products-tool"
          content={<BackgroundRemoverForProductsSeoLanding />}
