...
import RemoveBackgroundForDocumentsSeoLanding from "@/components/tools/RemoveBackgroundForDocumentsSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-for-documents")!;
...
export default function RemoveBackgroundForDocumentsPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-for-documents-tool"
          content={<RemoveBackgroundForDocumentsSeoLanding />}
