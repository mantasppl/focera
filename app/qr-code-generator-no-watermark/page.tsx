...
import QrCodeGeneratorNoWatermarkSeoLanding from "@/components/tools/QrCodeGeneratorNoWatermarkSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-generator-no-watermark")!;
...
export default function QrCodeGeneratorNoWatermarkPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-generator-no-watermark-tool"
          content={<QrCodeGeneratorNoWatermarkSeoLanding />}
