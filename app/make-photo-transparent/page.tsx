...
import MakePhotoTransparentSeoLanding from "@/components/tools/MakePhotoTransparentSeoLanding";
...
const page = getSeoLandingBySlug("make-photo-transparent")!;
...
export default function MakePhotoTransparentPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="make-photo-transparent-tool"
          content={<MakePhotoTransparentSeoLanding />}
