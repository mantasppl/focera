...
import YoutubeThumbnailBackgroundRemoverSeoLanding from "@/components/tools/YoutubeThumbnailBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("youtube-thumbnail-background-remover")!;
...
export default function YoutubeThumbnailBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="youtube-thumbnail-background-remover-tool"
          content={<YoutubeThumbnailBackgroundRemoverSeoLanding />}
