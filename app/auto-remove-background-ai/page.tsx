...
import AutoRemoveBackgroundAiSeoLanding from "@/components/tools/AutoRemoveBackgroundAiSeoLanding";
...
const page = getSeoLandingBySlug("auto-remove-background-ai")!;
...
export default function AutoRemoveBackgroundAiPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="auto-remove-background-ai-tool"
          content={<AutoRemoveBackgroundAiSeoLanding />}
