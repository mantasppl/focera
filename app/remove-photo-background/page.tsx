...
import RemovePhotoBackgroundSeoLanding from "@/components/tools/RemovePhotoBackgroundSeoLanding";
...
const page = getSeoLandingBySlug("remove-photo-background")!;
...
export default function RemovePhotoBackgroundPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-photo-background-tool"
          content={<RemovePhotoBackgroundSeoLanding />}
