...
import ImageBackgroundRemovalToolSeoLanding from "@/components/tools/ImageBackgroundRemovalToolSeoLanding";
...
const page = getSeoLandingBySlug("image-background-removal-tool")!;
...
export default function ImageBackgroundRemovalToolPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="image-background-removal-tool-tool"
          content={<ImageBackgroundRemovalToolSeoLanding />}
