...
import OfficialPhotoBackgroundRemoverSeoLanding from "@/components/tools/OfficialPhotoBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("official-photo-background-remover")!;
...
export default function OfficialPhotoBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="official-photo-background-remover-tool"
          content={<OfficialPhotoBackgroundRemoverSeoLanding />}
