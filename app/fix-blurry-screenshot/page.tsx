...
import FixBlurryScreenshotSeoLanding from "@/components/tools/FixBlurryScreenshotSeoLanding";
...
const page = getSeoLandingBySlug("fix-blurry-screenshot")!;
...
export default function FixBlurryScreenshotPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="fix-blurry-screenshot-tool"
          content={<FixBlurryScreenshotSeoLanding />}
