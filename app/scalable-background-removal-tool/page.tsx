...
import ScalableBackgroundRemovalToolSeoLanding from "@/components/tools/ScalableBackgroundRemovalToolSeoLanding";
...
const page = getSeoLandingBySlug("scalable-background-removal-tool")!;
...
export default function ScalableBackgroundRemovalToolPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="scalable-background-removal-tool-tool"
          content={<ScalableBackgroundRemovalToolSeoLanding />}
