...
import QrCodeGeneratorSeoLanding from "@/components/tools/QrCodeGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("qr-code-generator")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="qr-code-generator-tool"
          content={<QrCodeGeneratorSeoLanding />}
