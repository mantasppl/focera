...
import RestaurantMenuQrCodeGeneratorSeoLanding from "@/components/tools/RestaurantMenuQrCodeGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("restaurant-menu-qr-code-generator")!;
...
export default function RestaurantMenuQrCodeGeneratorPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="restaurant-menu-qr-code-generator-tool"
          content={<RestaurantMenuQrCodeGeneratorSeoLanding />}
