...
import CleanProductImageBackgroundSeoLanding from "@/components/tools/CleanProductImageBackgroundSeoLanding";
...
const page = getSeoLandingBySlug("clean-product-image-background")!;
...
export default function CleanProductImageBackgroundPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="clean-product-image-background-tool"
          content={<CleanProductImageBackgroundSeoLanding />}
