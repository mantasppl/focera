...
import ColorfulQrCodeGeneratorSeoLanding from "@/components/tools/ColorfulQrCodeGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("colorful-qr-code-generator")!;
...
export default function ColorfulQrCodeGeneratorPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="colorful-qr-code-generator-tool"
          content={<ColorfulQrCodeGeneratorSeoLanding />}
