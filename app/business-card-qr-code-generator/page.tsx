...
import BusinessCardQrCodeGeneratorSeoLanding from "@/components/tools/BusinessCardQrCodeGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("business-card-qr-code-generator")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="business-card-qr-code-generator-tool"
          content={<BusinessCardQrCodeGeneratorSeoLanding />}
