...
import CleanBackgroundFromImageSeoLanding from "@/components/tools/CleanBackgroundFromImageSeoLanding";
...
const page = getSeoLandingBySlug("clean-background-from-image")!;
...
export default function CleanBackgroundFromImagePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="clean-background-from-image-tool"
          content={<CleanBackgroundFromImageSeoLanding />}
