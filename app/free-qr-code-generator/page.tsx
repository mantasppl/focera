...
import FreeQrCodeGeneratorSeoLanding from "@/components/tools/FreeQrCodeGeneratorSeoLanding";
...
const page = getSeoLandingBySlug("free-qr-code-generator")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="free-qr-code-generator-tool"
          content={<FreeQrCodeGeneratorSeoLanding />}
