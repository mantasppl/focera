...
import RemoveBackgroundFromPhotoSeoLanding from "@/components/tools/RemoveBackgroundFromPhotoSeoLanding";
...
const page = getSeoLandingBySlug("remove-background-from-photo")!;
...
export default function RemoveBackgroundFromPhotoPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-background-from-photo-tool"
          content={<RemoveBackgroundFromPhotoSeoLanding />}
