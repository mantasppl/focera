...
import GraphicDesignBackgroundRemoverSeoLanding from "@/components/tools/GraphicDesignBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("graphic-design-background-remover")!;
...
export default function GraphicDesignBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="graphic-design-background-remover-tool"
          content={<GraphicDesignBackgroundRemoverSeoLanding />}
