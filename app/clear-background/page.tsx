...
import ClearBackgroundSeoLanding from "@/components/tools/ClearBackgroundSeoLanding";
...
const page = getSeoLandingBySlug("clear-background")!;
...
export default function ClearBackgroundPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="clear-background-tool"
          content={<ClearBackgroundSeoLanding />}
