...
import BestFreeQrCodeGeneratorToolsSeoLanding from "@/components/tools/BestFreeQrCodeGeneratorToolsSeoLanding";
...
const page = getSeoLandingBySlug("best-free-qr-code-generator-tools")!;
...
export default function BestFreeQrCodeGeneratorToolsPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="best-free-qr-code-generator-tools-tool"
          content={<BestFreeQrCodeGeneratorToolsSeoLanding />}
