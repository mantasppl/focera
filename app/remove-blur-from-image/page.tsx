...
import RemoveBlurFromImageSeoLanding from "@/components/tools/RemoveBlurFromImageSeoLanding";
...
const page = getSeoLandingBySlug("remove-blur-from-image")!;
...
export default function RemoveBlurFromImagePage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="remove-blur-from-image-tool"
          content={<RemoveBlurFromImageSeoLanding />}
