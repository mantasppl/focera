...
import AutomationBackgroundRemoverSeoLanding from "@/components/tools/AutomationBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("automation-background-remover")!;
...
export default function AutomationBackgroundRemoverPage() {
  const displayTool = {
    ...parentTool,
    name: page.h1,
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="automation-background-remover-tool"
          content={<AutomationBackgroundRemoverSeoLanding />}
