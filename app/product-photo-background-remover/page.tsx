...
import ProductPhotoBackgroundRemoverSeoLanding from "@/components/tools/ProductPhotoBackgroundRemoverSeoLanding";
...
const page = getSeoLandingBySlug("product-photo-background-remover")!;
  ...
  return (
    <>
      ...
      <ToolAnalyticsProvider toolId={parentTool.slug}>
        <ToolLayout
          tool={displayTool}
          workspaceId="product-photo-background-remover-tool"
          content={<ProductPhotoBackgroundRemoverSeoLanding />}
