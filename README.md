...
| `GROQ_API_KEY` | Required for Video Autocaption transcription (Groq Whisper) and AI writing tools (Content Improver, Essay Writer). Pollinations is an optional fallback for writing tools |
