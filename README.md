...
| `GROQ_API_KEY` | Required for Video Autocaption transcription (Groq Whisper), AI writing tools (Content Improver, Essay Writer), admin AI blog draft generation (`POST /api/ai/generate-post`), and 90s Photo Generator prompt writing. Pollinations is an optional fallback for writing tools |
